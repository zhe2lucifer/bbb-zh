...
/** default path for certificate: set from upper middleware */
//#define UPG_CA_PATH "/usr/mnt_appdb/upg/UPG_CA"
...
/**
 *  Function Name:  net_set_ca_path
 *  @brief          set ca path for https upgrade 
 *
 *  @param          ca_path CA path
 *
 *  @return         none
 *
 ...
 *  @date           2015-10-08
 *
 *  Set CA path for https TLS upgrade
 */
